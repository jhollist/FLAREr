...
```{r}
file.copy(system.file(file.path("example", "configuration", "default", "configure_flare.yml"), package = "FLAREr"), file.path(lake_directory, "configuration", "flarer", "configure_flare.yml"))
file.copy(system.file(file.path("example", "configuration", "default", "configure_run.yml"), package = "FLAREr"), file.path(lake_directory, "configuration", "flarer", "configure_run.yml"))
```
...
```{r}
file.copy(system.file(file.path("example", "configuration", "default", "parameter_calibration_config.csv"), package = "FLAREr"), file.path(lake_directory, "configuration", "flarer", "parameter_calibration_config.csv"))
file.copy(system.file(file.path("example", "configuration", "default", "states_config.csv"), package = "FLAREr"), file.path(lake_directory, "configuration", "states_config.csv"))
file.copy(system.file(file.path("example", "configuration", "default", "depth_model_sd.csv"), package = "FLAREr"), file.path(lake_directory, "configuration", "depth_model_sd.csv"))
file.copy(system.file(file.path("example", "configuration", "default", "observations_config.csv"), package = "FLAREr"), file.path(lake_directory, "configuration", "flarer", "observations_config.csv"))
```
...
```{r}
file.copy(system.file(file.path("example", "configuration", "default", "glm3.nml"), package = "FLAREr"), file.path(lake_directory, "configuration", "forecast_model", "glm", "glm3.nml"))
```
...
```{r}
all_files <- list.files(file.path(lake_directory,"forecasted_drivers/inflow/FLOWS-NOAAGEFS-AR1"), full.names = TRUE)
...
```{r}
all_files <- list.files(file.path(lake_directory, "forecasted_drivers/noaa/NOAAGEFS_1hr-debias"), full.names = TRUE)
basename(all_files)
```
